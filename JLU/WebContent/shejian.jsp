	...
	<li class="lli"><a href="getNewsByType?type=2">要闻通知</a></li>
            ...
            <div class="main">
                <div class="left">
                    <div class="box_1">
                        ...
                        <div class="left_news">
                            <ul>
                                <li>
                                    <a href="getCommentAction?type=zhiwu">植物大战僵尸</a>
                                </li>
                                <li>
                                    <a href="getCommentAction?type=shejian" class="hover">射箭救人</a>
                                </li>
                                <li>
                ...
                <div class="right">
                    ...
                    <div class="xiangqing">
                        <br/>
<iframe scrolling="no" height="405" frameborder="0" width="540" src="http://files2.17173.com/sjflash/2012092702.swf" name="gameobj" id="gameobj" marginwidth="0" marginheight="0"></iframe>
                        <br/>
                            ...
                            <table bgcolor="#F0F0F0" width="540">
                            	...
                            	<div class="fanye">
			                        <div class="fanye_left">
			                            ...
			                            分页：<a href="getCommentAction?currentPage=${currentPage-1}&type=shejian"><img src="images/img_13.gif" /></a>${currentPage}
			                            <a href="getCommentAction?currentPage=${currentPage+1}&type=shejian"><img src="images/img_14.gif" /></a>
			                        </div>
			                    </div>
...
<textarea name="content"
	...
	<input name="type" value="shejian" type="hidden" />
