                ...
                <div class="right">
                    ...
                    <div class="fanye">
                        ...
                        <div class="fanye_right">
                            分页：<a href="getMessageAction?currentPage=${currentPage-1}"><img src="images/img_13.gif" /></a>${currentPage}
                            <a href="getMessageAction?currentPage=${currentPage+1}"><img src="images/img_14.gif" /></a>
                        </div>
                    </div>
                </div>
            </div>
