                ...
                <div class="left">
                    <div class="box_1">
                        ...
                        <div class="left_news">
                            <ul>
	<li><a href="getNewsByType?type=0">社联新闻</a></li>
	<li><a href="getNewsByType?type=1" class="hover">社团新闻</a></li>
                ...
                <div class="right">
                    ...
                    <div class="liebiao">
                        <ul>
                            ...
                            <li>
                            	<b>
                                <a href="getTheNews?id=${id}&title=${title}" >${title}</a>                                
                                <span>${author}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ${partment}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${date}</span>
                            	</b>
                            </li>
                    ...
                    <div class="fanye">
                        ...
                        <div class="fanye_right">
                            分页：<a href="getSheTuanNews?currentPage=${currentPage-1}"><img src="images/img_13.gif" /></a>${currentPage}
                            <a href="getSheTuanNews?currentPage=${currentPage+1}"><img src="images/img_14.gif" /></a>
                        </div>
                    </div>
                </div>
                <div class="clear">
