	...
	<li class="lli"><a href="getNewsByType?type=2">要闻通知</a></li>
            ...
            <div class="main">
                ...
                <div class="right">
                    ...
                    <div class="xiangqing">
                        <form name="example" method="post" action="updataNewsAction">
                            <br/>
                            <b>新闻种类：</b>
                            <select name="type">
                            ...
                            <input name="title" id="title" type="text" value="<s:property value="title" />" readonly="readonly" size="40" style="width:450px"/>
                            <br/>
                            <br/>
                            <textarea name="content" cols="100" rows="8" style="width:690px;height:300px;visibility:hidden;">
                                <s:property value="content"/>
                                <%=htmlspecialchars(htmlData) %>
                            </textarea>
                            <br/>
                            <b>是否置顶：</b>
                            <input name="state" value="1" type="checkbox" /><input type="submit" name="button" value="提交内容" style="margin-left:370px"/>(提交快捷键: Ctrl + Enter)
                        </form>
                    </div>
                </div>
            </div>
