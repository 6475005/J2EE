                ...
                <div class="right">
                    ...
                    <div class="liebiao">
                        <ul>
                            ...
                            <li>
                            	<b>
                                <a href="getTheMessage?id=${id}">${title}</a>                                
                                <span>${author}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ${partment}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${date}</span>
                               </b>
                            </li>
                    ...
                    <div class="fanye">
                        ...
                        <div class="fanye_right">
                            分页：<a href="getMessageDitals?currentPage=${currentPage-1}"><img src="images/img_13.gif" /></a>${currentPage}
                            <a href="getMessageDitals?currentPage=${currentPage+1}"><img src="images/img_14.gif" /></a>
                        </div>
                    </div>
                </div>
            </div>
