...
this.setHomePage('http://www.jluccstsl.com/');" style="CURSOR: hand">设为首页</span>
            ...
            <div class="meun_2">[欢迎您：<s:property value="#session.NAME" /> 您上次登陆的时间为 <s:property value="#session.TIME" />] </div>
            <div class="main">
                <div class="left">
                    <div class="box_1">
                ...
                <div class="right">
                    ...
                    <div class="liebiao">
                        <ul>
                            ...
                            <li>
                            	<b>
                                <a href="deleteMessageAction?id=${id}" onclick="return confirm('确定要删除吗？');" >${title}</a>                                
                                <span>${author}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ${partment}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${date}</span>
                               </b>
                            </li>
                    ...
                    <div class="fanye">
                        <div class="fanye_left">
                            页次：${currentPage}/${countPage} 页　每页10
                        </div>
                        <div class="fanye_right">
                            分页：<a href="getMessageToDelete?currentPage=${currentPage-1}"><img src="images/img_13.gif" /></a>${currentPage}
                            <a href="getMessageToDelete?currentPage=${currentPage+1}"><img src="images/img_14.gif" /></a>
                        </div>
                    </div>
                </div>
            </div>
