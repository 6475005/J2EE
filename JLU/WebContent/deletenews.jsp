                ...
                <div class="right">
                    ...
                    <div class="liebiao">
                        <ul>
                            ...
                            <li>
                            	<b>
                                <a href="deleteNewsAction?id=${id}" onclick="return confirm('确定要删除吗？');" >${title}</a>                                
                                <span>${author}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ${partment}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${date}</span>
                               </b>
                            </li>
                    ...
                    <div class="fanye">
                        ...
                        <div class="fanye_right">
                            分页：<a href="getNewsToDelete?currentPage=${currentPage-1}"><img src="images/img_13.gif" /></a>${currentPage}
                            <a href="getNewsToDelete?currentPage=${currentPage+1}"><img src="images/img_14.gif" /></a>
                        </div>
                    </div>
                </div>
            </div>
