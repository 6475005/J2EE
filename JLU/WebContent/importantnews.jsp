...
<div class="right">
<div class="right_title"><b>要闻提示</b>
<div>首页 - 新闻信息 - <span>要闻提示</span></div>
</div>
<div class="liebiao">
<ul>
...
<div class="fanye_right">分页：<a href="getImportantNews?currentPage=${currentPage-1}"><img
	src="images/img_13.gif" /></a>${currentPage}<a
	href="getImportantNews?currentPage=${currentPage+1}"><img src="images/img_14.gif" /></a></div>
</div>
</div>
<div class="clear"></div>
<div class="huoban">
