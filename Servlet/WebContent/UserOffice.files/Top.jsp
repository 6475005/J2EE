...
href="buildings.jsp" target=mainFrame>返回首页</A> <IMG 
src="Top.files/menu_seprator.gif" align=absMiddle> <A id=HyperLink3 
href="../logout.jsp" target=_top>退出系统</A> </DIV>
...
style="BACKGROUND-IMAGE: url(../images/bg_nav.gif); BACKGROUND-REPEAT: repeat-x; HEIGHT: 30px">
      <TABLE cellSpacing=0 cellPadding=0 width="100%">
        <TBODY>
          <TR>
            <TD>
              <DIV><IMG src="Top.files/nav_pre.gif" align=absMiddle><SPAN 
      id=lblBra>小区物业管理</SPAN>--欢迎： [<%=id %>]<%=username %> 光临 </DIV>
            </TD>
      ...
      src="Top.files/nav_changePassword.gif" align=absMiddle border=0>重新登录</A> <A href="repassword.jsp"
      target=mainFrame><IMG src="Top.files/nav_resetPassword.gif" 
      align=absMiddle border=0>修改密码</A> <A 
      href="help.html" target=mainFrame><IMG 
